...
export default function ResetPassword() {
  ...
  if (!codeVerified) {
    return (
      <AuthLayout>
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow p-6">
          <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-4 text-center">
            Reset Link Invalid
          </h1>
  ...
  return (
    <AuthLayout>
      <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow p-6 w-[500px] sm:w-[440px]">
        <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-2 text-center whitespace-nowrap inline-flex items-center justify-center">
          Reset Password
        </h1>
