...
export default function Register() {
  ...
  const handleGoogleSignup = () => {
    ...
    // Build Google OAuth URL (same as login - backend creates account if doesn't exist)
  ...
  return (
    <AuthLayout>
      <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow p-6">
        <h1 className="text-2xl font-semibold text-slate-900 dark:text-slate-100 mb-6 text-center">Create account</h1>
